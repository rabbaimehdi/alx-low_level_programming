 ...
 *
 * Description: If be closed - exit code 98.
 */
void closeelf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - Displays contained in the
 *        ELF header at the start of an ELF file.
 * @argc: The number of to the program.
 * @argv: An array to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: If an ELF File or
